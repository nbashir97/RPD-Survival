...
*** Do-File 5: Sensitivity Analysis - Data Cleaning ***
...
generate personal = 1 if(HAH13 == 1)
replace personal = 0 if(HAH13 == 2)

generate routine = 1 if(HAH14 == 1)
replace routine = 0 if(HAH14 == 2)
replace routine = 1 if(personal == 1)

generate movement = 1 if(HAH15 == 1)
replace movement = 0 if(HAH15 == 2)

label define adl_lab 0 "Unaffected" 1 "Affected" 

foreach var of varlist personal-movement {
	label values `var' adl_lab
}
...
foreach var of varlist age-movement {
...
save "`path'/nhanes3_sens_cleaned.dta", replace
